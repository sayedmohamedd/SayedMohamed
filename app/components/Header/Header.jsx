...
import TypeWriterComponent from "@/app/components/TypeWriterComponent";
  ...
  return (
    <header className="bg-dark" id="home">
      <div className="grid grid-cols-12 min-h-screen">
        <aside className="md:col-span-2 hidden md:flex flex-col justify-between items-center py-10 h-full text-white">
          <Logo />
